...
# Labels
emotion_labels = sorted(df_train["emotion"].dropna().unique())
...
# Save
pd.DataFrame({"id": df_test["id"].tolist(), "emotion": pred_labels}).to_csv("BERTweet_base_1.csv", index=False)
print("Saved to BERTweet_base_1.csv")
